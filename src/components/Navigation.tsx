      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center hover:opacity-80 transition-opacity">
            <div className="flex items-center gap-2 relative h-full w-48">
            <img src="/logo.png" alt="Cyberscam Watchdog Logo" className="absolute top-1/2 -translate-y-1/2 -left-2 h-24 max-w-none object-contain" />
          </div>
          </Link>

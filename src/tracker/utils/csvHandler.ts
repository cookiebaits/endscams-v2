...
export function parseAndValidateCSV(fileContent: string): CSVParseResult {
  ...
  for (let rIdx = 1; rIdx < rawRows.length; rIdx++) {
    ...
    // STRICT REQUIREMENT: Reject toll-free numbers (800, 888, 877, 866, 855, 844, 833)
    ...
    // STRICT REQUIREMENT: Reject fictitious / dummy / 555 / sequential numbers
    ...
    // STRICT REQUIREMENT: Reject unverified Reddit sources

...
export class BuiltinNoSqlDatabase {
  ...
  private initDatabase() {
    ...
    // 2. If empty, seed from the built-in database seed or presets bundled in the source code
    ...
    if (initialRecords.length === 0 && Array.isArray(INITIAL_SAMPLE_RECORDS) && INITIAL_SAMPLE_RECORDS.length > 0) {
      initialRecords = INITIAL_SAMPLE_RECORDS as ScamPhoneRecord[];
    }

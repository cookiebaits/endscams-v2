    ...
    <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-xl overflow-hidden">
      ...
      <div className="p-4 border-b border-slate-800 space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1 border-t border-slate-800/80 text-xs">
          ...
          >
            <option value="ALL">All 60 Days ({records.length})</option>
      ...
      {isMobileActive ? (
        ...
        <>
          ...
          <div className="p-3 bg-slate-950 border-t border-slate-800 flex items-center justify-between text-xs text-slate-400">
            <div>
              Showing <strong>{processedRecords.length}</strong> of <strong>{records.length}</strong> entries (60-day retention policy active)
              {selectedIds.length > 0 && (
            ...
            <form onSubmit={handleThreatSearchSubmit} className="space-y-4">
              ...
              <div className="p-3 bg-slate-950 border border-slate-800 rounded-xl space-y-1 text-xs text-slate-400">
                <div className="flex items-center text-amber-400 font-semibold gap-1.5 text-[11px]">
                  ...
                  <span>Incremental Addition & 60-Day Retention Guarantee</span>
                </div>
                <p className="text-[11px]">
                  Discovered numbers will be incrementally added onto your existing retained database. Existing records are never replaced or wiped, and all entries remain securely preserved for up to 60 days.
                </p>
              </div>

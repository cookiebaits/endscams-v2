...
export interface SearchPreset {
  ...
  platform: 'Facebook' | 'Instagram' | 'Guestbook' | 'Web Search' | string;
...
export interface ScamPhoneRecord {
  ...
  altNumbers?: string[];      // Alternate numbers tied to this threat incident
  ...
  detailedSummary?: string;     // Summary of what the scam is, amount charged, etc.
  ...
  isNumberDown?: boolean;     // Whether the number has been marked as dead / inactive
...
export type FormData = ReportFormData;
